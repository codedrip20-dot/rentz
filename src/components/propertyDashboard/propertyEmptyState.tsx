...
const PropertyEmptyState = () => {
    ...
    return (
        <motion.section
            ...
            className="relative overflow-hidden rounded-[24px] border border-white/10 bg-white/5 px-4 py-14 backdrop-blur-2xl sm:rounded-[28px] sm:px-6 sm:py-18 md:rounded-[32px] md:px-8 md:py-24"
        >
            {/* Background */}
            ...
            <div className="absolute -right-20 bottom-0 h-64 w-64 rounded-full bg-cyan-500/10 blur-[110px] sm:h-80 sm:w-80 sm:blur-[140px]" />
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
                ...
                >
                    ...
                    <div className="relative flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-500 shadow-[0_0_60px_rgba(37,99,235,0.45)] sm:h-24 sm:w-24 sm:rounded-3xl md:h-28 md:w-28">
                        <Building2 className="h-10 w-10 text-white sm:h-12 sm:w-12 md:h-14 md:w-14" />
                    </div>
                </motion.div>
                ...
                {/* Bottom Features */}
                <div className="mt-10 grid w-full max-w-3xl grid-cols-1 gap-3 sm:mt-12 sm:gap-4 md:mt-16 md:grid-cols-3">
                    ...
                    {[
                        ...
                        <div
                            key={item}
                            className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3.5 backdrop-blur-xl sm:px-5 sm:py-4"
                        >
